...
class TestDaskExpression:
    ...
    def test_dask_expression_build_tree_simple_expression(self):
        ...
        expr.build_tree()
        assert expr.parse_tree.original_root.value == "+"
        assert expr.parse_tree.original_root.right.value == "5"
        assert expr.parse_tree.original_root.left.value == "3"
    ...
    def test_dask_expression_build_tree_complex_expression(self):
        ...
        expr.build_tree()
        assert expr.parse_tree.original_root.value == "+"
        assert expr.parse_tree.original_root.right.value == "A"
        assert expr.parse_tree.original_root.left.value == "*"
    ...
    def test_dask_expression_build_tree_with_numbers(self):
        ...
        expr.build_tree()
        assert expr.parse_tree.original_root.value == "+"
        assert expr.parse_tree.original_root.right.value == "100"
        assert expr.parse_tree.original_root.left.value == "200"
